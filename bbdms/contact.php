...
<head>
	<title>Blood Care Connect | Contact Us </title>
	<!-- Meta tag Keywords -->
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2"><b>Always feel free to contact us.</b></p>
			</div>
			<div class="d-flex">
				...
				<div class="col-lg-7 contact-right-w3l">
					...
					<form action="#" method="post">
						<div class="d-flex space-d-flex">
							...
							<div class="form-group grid-inputs">
                  				 <input type="tel" class="form-control" id="phone" name="contactno" placeholder="Please enter your phone number" oninput="javascript: if (this.value.length > 10) this.value = this.value.slice(0, 10);">
							</div>
						</div>
