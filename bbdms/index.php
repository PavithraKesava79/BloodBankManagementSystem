...
<head>
	<title>Blood Care Connect | Home Page</title>
...
<li>AB positive or AB negative.</li>
			...
			<div class="col-md-4" style="padding-top: 30px;"> 
				...
				<a class="btn btn-primary" style="color:#fff" href="Diet-Plan.php">Diet Plan</a>
			</div>
        </div>
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</b></p>
            </div>
            <div class="col-md-4" style="padding-top: 30px;"> 
    
                <a class="btn btn-primary" style="color:#fff" href="login.php">Become a Donar</a>
            </div>
        </div>
		</div>
	</div>
